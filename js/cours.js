/********* On récupère les datas d'une API *****/
...
/****** On push dans des array les différentes options des catégories *****/
...
/******* On envoie les catégories dans les select Html **********/
...
/****** On récupère les données du localStorage si elles sont présentes dedans$
        Sinon on les prends toutes *******/
...
/******* On choisit un personnage random ********/
...
/****** On affiche les images récupérés ******/
...
/******* On regarde si des points sont stockés dans le localStorage 
         Sinon on met le compteur à 0 ******/
async function getPoints(){
    ...
    document.getElementById('points').innerHTML = 'Tentative : ' + points
    return points
}
